...
> **ملاحظة:** هذه حزمة مجتمعية غير رسمية. خط ثمانية من تصميم وملكية [ثمانية](https://thmanyah.com). هذا المستودع يعيد تجميع الخطوط فقط لتسهيل استخدامها على الويب عبر npm و CDN.
